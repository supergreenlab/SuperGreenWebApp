...
import GraphSubSection from '~/components/controls/monitoring/graphsubsection.vue'
import Status from '~/components/controls/monitoring/status.vue'
...
export default {
  ...
  methods: {
    toggleExpand() {
      this.$matomo && this.$matomo.trackEvent('monitoring', 'expand')
      this.$data.contentHeight = this.$refs.content.clientHeight
