...
<script>
import IsMyPlantOk from '~/components/social/ismyplantok/ismyplantok.vue'
import RemoteCamera from '~/components/controls/remotecamera/remotecamera.vue'
import Monitoring from '~/components/controls/monitoring/monitoring.vue'
import BlowerControl from '~/components/controls/blower/blowercontrol.vue'
import Dimming from '~/components/controls/dimming/dimming.vue'
import Schedule from '~/components/controls/schedule/schedule.vue'
